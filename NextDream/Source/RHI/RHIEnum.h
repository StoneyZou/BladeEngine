...
namespace BladeEngine
{
    namespace RHI
    {
        ...
        enum ETEXTURE_FILTER_MODE
        {
            ...
            ETEXTURE_FILTER_MIN_LINEAR_MAG_MIP_POINT = ETEXTURE_FILTER_MIN_POINT | ETEXTURE_FILTER_MAG_POINT | ETEXTURE_FILTER_MIP_POINT,
            ETEXTURE_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT = ETEXTURE_FILTER_MIN_POINT | ETEXTURE_FILTER_MAG_POINT | ETEXTURE_FILTER_MIP_POINT,
            ETEXTURE_FILTER_MIN_MAG_POINT_MIP_LINEAR = ETEXTURE_FILTER_MIN_POINT | ETEXTURE_FILTER_MAG_POINT | ETEXTURE_FILTER_MIP_POINT,

            ETEXTURE_FILTER_MIN_MAG_LINEAR_MIP_POINT = ETEXTURE_FILTER_MIN_POINT | ETEXTURE_FILTER_MAG_POINT | ETEXTURE_FILTER_MIP_POINT,
            ETEXTURE_FILTER_MIN_POINT_MAG_MIP_LINEAR = ETEXTURE_FILTER_MIN_POINT | ETEXTURE_FILTER_MAG_POINT | ETEXTURE_FILTER_MIP_POINT,
            ETEXTURE_FILTER_MIN_LINEAR_MAG_POINT_MIP_LINEAR = ETEXTURE_FILTER_MIN_POINT | ETEXTURE_FILTER_MAG_POINT | ETEXTURE_FILTER_MIP_POINT,

            ETEXTURE_FILTER_MIN_MAG_MIP_LINEAR = ETEXTURE_FILTER_MIN_POINT | ETEXTURE_FILTER_MAG_POINT | ETEXTURE_FILTER_MIP_POINT,
        };
    }
}
