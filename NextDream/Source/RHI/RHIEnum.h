...
namespace BladeEngine
{
    ...
    {
        ETEX_FORMAT_USAGE_RENDER_TARGET = 0x0001,    // 仅用于特殊使用的内部类型
        ETEX_FORMAT_USAGE_DEPTH_STENCIL = 0x0002,
        ETEX_FORMAT_USAGE_SHADER_RESOURCE = 0x0004,
    ...
    enum ETEX_FORMAT
    {
        ETEX_FORMAT_R8G8B8A8_TYPELESS =    GenDataFormat(ETEX_FORMAT_LAYOUT_R8G8B8A8,    ETEX_FORMAT_TYPE_TYPELESS,     ETEX_FORMAT_USAGE_SHADER_RESOURCE),
        ETEX_FORMAT_R8G8B8A8_UINT =        GenDataFormat(ETEX_FORMAT_LAYOUT_R8G8B8A8,    ETEX_FORMAT_TYPE_UINT,         ETEX_FORMAT_USAGE_SHADER_RESOURCE),
        ETEX_FORMAT_R8G8B8A8_SINT =        GenDataFormat(ETEX_FORMAT_LAYOUT_R8G8B8A8,    ETEX_FORMAT_TYPE_SINT,         ETEX_FORMAT_USAGE_SHADER_RESOURCE),
        ETEX_FORMAT_R8G8B8A8_UNORM =       GenDataFormat(ETEX_FORMAT_LAYOUT_R8G8B8A8,    ETEX_FORMAT_TYPE_UNORM,        ETEX_FORMAT_USAGE_R_S),
        ETEX_FORMAT_R8G8B8A8_SNORM =       GenDataFormat(ETEX_FORMAT_LAYOUT_R8G8B8A8,    ETEX_FORMAT_TYPE_SNORM,        ETEX_FORMAT_USAGE_SHADER_RESOURCE),
        ETEX_FORMAT_D32_FLOAT_S8_UINT =    GenDataFormat(ETEX_FORMAT_LAYOUT_D32S8,       ETEX_FORMAT_TYPE_INTERNAL,     ETEX_FORMAT_USAGE_DEPTH_STENCIL),
        ETEX_FORMAT_D32_FLOAT =            GenDataFormat(ETEX_FORMAT_LAYOUT_D32,         ETEX_FORMAT_TYPE_INTERNAL,     ETEX_FORMAT_USAGE_DEPTH_STENCIL),
        ETEX_FORMAT_D24_UNORM_S8_UINT =    GenDataFormat(ETEX_FORMAT_LAYOUT_D24S8,       ETEX_FORMAT_TYPE_INTERNAL,     ETEX_FORMAT_USAGE_DEPTH_STENCIL),
        ETEX_FORMAT_D24_UNORM =            GenDataFormat(ETEX_FORMAT_LAYOUT_D24,         ETEX_FORMAT_TYPE_INTERNAL,     ETEX_FORMAT_USAGE_DEPTH_STENCIL),
        ETEX_FORMAT_D16_UNORM =            GenDataFormat(ETEX_FORMAT_LAYOUT_D16,         ETEX_FORMAT_TYPE_INTERNAL,     ETEX_FORMAT_USAGE_DEPTH_STENCIL),
    };
    ...
    enum ESHADER_SEMANTIC_TYPE
    {
        ...
        ESHADER_SEMANTIC_BLENDINDICES = ESHADER_SEMANTIC_BINORMAL + 1,
        ESHADER_SEMANTIC_BLENDWEIGHT = ESHADER_SEMANTIC_BLENDINDICES + 1,
