#ifndef __BLADE_RHI_COMMAND_BASE_H__
#define __BLADE_RHI_COMMAND_BASE_H__
...
namespace BladeEngine
{
    ...
    public:
        ...
        {
            RHICmdSetShaderState* cmd = (RHICmdSetShaderState*)Malloc::Alloc(sizeof(RHICmdSetShaderState));
            BladeConstruct(cmd, inShaderState, m_LastCommand);
        }

        void AddCmdSetVertexShader(RHIShaderStateRef& inShaderState)
        {
            RHICmdSetVertexShader* cmd = (RHICmdSetVertexShader*)Malloc::Alloc(sizeof(RHICmdSetVertexShader));
            BladeConstruct(cmd, inShaderState, m_LastCommand);
        }
    };
...
#endif	//!__BLADE_RHI_COMMAND_BASE_H__
